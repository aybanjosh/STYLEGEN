...
<head>
    ...
    <title>Ladies Casual Pants With Pockets</title>
...
<div class="container content-container" style="font-family: 'Poppins', sans-serif; font-weight: bold; font-size: 0.9rem;">
    <div class="product-page">
        ...
        <img id="mainProductImage" src="lpants.png" alt="Main Product Image" onclick="showSelectedColor()" style="border: 2px solid #ddd; border-radius: 4px; padding: 5px; margin-bottom: 50px;">
        </div>

        <!-- Product Details -->
        <div class="product-details">
            <h1>Ladies Casual Pants With Pockets</h1>
        ...
        (<span id="reviewCount">0</span> Reviews)
            ...
            <p class="price" style="color: #B0C6B5;"><strong>₱416.00</strong> <span class="original-price" style="color: #F8D0C8;">₱489.00</span></p>
            <div class="mb-3">
...
document.addEventListener('DOMContentLoaded', function () {
    const productId = 9; // Replace with your dynamic product ID
    ...
    <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab" style="padding: 20px; border: 1px solid #ddd; border-radius: 5px; margin-bottom: 20px;">
        <p>Experience the perfect blend of comfort and style with the Ladies Casual Pants With Pockets. Designed for everyday wear, these pants feature a relaxed fit with functional side pockets for added convenience. Whether you're running errands, heading to a casual outing, or relaxing at home, the breathable fabric and modern design make them a must-have in your wardrobe. The lightweight material ensures comfort throughout the day, while the versatile color options easily pair with various tops and footwear.</p>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="reviewForm">
                    <!-- Set product_id to 9 dynamically -->
...
<script>
    ...
    const productId = document.getElementById('productId').value; // Product ID set to 9
...
<script>
    let currentColor = "Brown"; // Track the current color
