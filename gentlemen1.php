...
<div class="animate-left-to-right container my-5" style="font-family: 'Poppins', sans-serif;" >
    ...
    <div class="row g-4">
        ...
        <div class="col-md-3 col-sm-6">
            <div class="product-card position-relative">
                ...
                <div class="product-details">
                    <span class="product-label" style="background-color: #80C4E9; color: white;">ARRIVING SOON</span>
                    <h5 class="product-title">Gentlemen Slant Pockets Straight Leg Shorts</h5>
                    <p class="product-price" style="color: #687B61;">₱4??.00 </p>
        ...
        <div class="product-card position-relative">
                ...
                <h5 class="product-title">Gentlemen's Short Sleeve Polo Shirt Collar All White</h5>
                    <p class="product-price" style="color: #687B61;">₱2??.00 </p>
                    <div class="product-actions">
                        <button class="cart-btn">Add to Cart</button>
                        <span style="color: orange;">☆☆☆☆☆</span>
                    </div>
