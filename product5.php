...
<head>
    ...
    <title>Hypemode Gentlemen's Denim Shorts</title>
...
<div class="container content-container" style="font-family: 'Poppins', sans-serif; font-weight: bold; font-size: 0.9rem; margin-bottom: 20px;">
    <div class="product-page">
        ...
        <div class="sidebar-images">
            <img src="jorts1.png" alt="Thumbnail Multicolor 1" onclick="changeMainImage('jorts1.png', 'Dark Grey')">
            <img src="jorts2.png" alt="Thumbnail Multicolor 2" onclick="changeMainImage('jorts2.png', 'Dark Grey')">
            <img src="jorts3.png" alt="Thumbnail Multicolor 2" onclick="changeMainImage('jorts3.png', 'Dark Grey')">
            <img src="jorts4.png" alt="Thumbnail Multicolor 2" onclick="changeMainImage('jorts4.png', 'Dark Grey')">

        </div>

        <!-- Main Image -->
        <div class="main-image">
        <img id="mainProductImage" src="short3.png" alt="Main Product Image" onclick="showSelectedColor()" style="border: 2px solid #ddd; border-radius: 4px; padding: 5px; margin-bottom: 50px;">
        </div>

        <!-- Product Details -->
        <div class="product-details">
            <h1>Hypemode Gentlemen's Denim Shorts</h1>
        ...
        (<span id="reviewCount">0</span> Reviews)
                ...
                <p class="price" style="color: #B0C6B5;"><strong>₱706.00</strong> <span class="original-price" style="color: #F8D0C8;">₱831.00</span></p>
            <div class="mb-3">
            </div>
            <div class="mb-3">
                <strong>Size:</strong>
...
document.addEventListener('DOMContentLoaded', function () {
    const productId = 11; // Replace with your dynamic product ID
...
<div class="tab-content" id="productTabContent">
    ...
    <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab" style="padding: 20px; border: 1px solid #ddd; border-radius: 5px; margin-bottom: 20px;">
        <p>Step into summer with style and comfort with the <strong>Hypemode Gentlemen's Denim Shorts</strong>. Crafted for a perfect casual look, these denim shorts offer a relaxed fit that hits just above the knee, making them ideal for warm weather. Featuring a timeless design, these shorts come with functional pockets and a sturdy zipper fly. Whether you're out for a walk, meeting up with friends, or enjoying a weekend getaway, these shorts are a must-have addition to your wardrobe.</p>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="reviewForm">
                    <!-- Set product_id to 11 dynamically -->
...
<script>
    ...
    const productId = document.getElementById('productId').value; // Product ID set to 11
