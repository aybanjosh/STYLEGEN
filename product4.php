...
<head>
    ...
    <title>Ladies Loose Fit Short Sleeve T-Shirt</title>
...
<div class="container content-container" style="font-family: 'Poppins', sans-serif; font-weight: bold; font-size: 0.9rem;">
    <div class="product-page">
        ...
        <img id="mainProductImage" src="lrandom3.png" alt="Main Product Image" onclick="showSelectedColor()" style="border: 2px solid #ddd; border-radius: 4px; padding: 5px; margin-bottom: 50px;">
        </div>

        <!-- Product Details -->
        <div class="product-details">
            <h1>Ladies Loose Fit Short Sleeve T-Shirt</h1>
        ...
        (<span id="reviewCount">0</span> Reviews)
            ...
            <p class="price" style="color: #B0C6B5;"><strong>₱152.00</strong> <span class="original-price" style="color: #F8D0C8;">₱180.00</span></p>
            <div class="mb-3">
...
document.addEventListener('DOMContentLoaded', function () {
    const productId = 10; // Replace with your dynamic product ID
    loadProductRating(productId);
        ...
        <div class="tab-content" id="productTabContent">
                ...
                <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab" style="padding: 20px; border: 1px solid #ddd; border-radius: 5px; margin-bottom: 20px;">
                    <p>Experience the perfect blend of comfort and style with the Ladies Loose Fit Short Sleeve T-Shirt. Made from soft, breathable fabric, this t-shirt offers a relaxed fit for ultimate comfort throughout the day. The short sleeves and classic round neck design make it an easy match for jeans, shorts, or skirts. Whether you're out for a casual outing or lounging at home, this t-shirt is an essential piece for any wardrobe.</p>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="reviewForm">
                    <!-- Set product_id to 10 dynamically -->
...
<script>
    ...
    const productId = document.getElementById('productId').value; // Product ID set to 10
