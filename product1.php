...
<head>
    ...
    <title>Double-Breasted Collar Pressed-Pleated Dress</title>
...
<div class="container content-container" style="font-family: 'Poppins', sans-serif; font-weight: bold; font-size: 0.9rem;">
    <div class="product-page">
        ...
        <div class="sidebar-images">
            <img src="blackdress.png" alt="Thumbnail Multicolor 1" onclick="changeMainImage('blackdress.png', 'Black')">
            <img src="blackdress1.png" alt="Thumbnail Multicolor 2" onclick="changeMainImage('blackdress1.png', 'Black')">
        </div>

        <!-- Main Image -->
        <div class="main-image">
            <img id="mainProductImage" src="blackdress.png" alt="Main Product Image" onclick="showSelectedColor()" style="border: 2px solid #ddd; border-radius: 4px; padding: 5px;">
        </div>

        <!-- Product Details -->
        <div class="product-details">
    <h1>Double-Breasted Collar Pressed-Pleated Dress</h1>
    ...
    <p class="price" style="color: #B0C6B5;">
        <strong>₱766.00</strong> <span class="original-price" style="color: #F8D0C8;">₱959.00</span>
    </p>
            <div class="mb-3">
                <strong>Color:</strong> <span id="selectedColor">Black</span>
                <div class="color-options">
                    <img src="red.png" alt="Red" class="color-selector" onclick="changeColor('Red')">
                    <img src="blackdress.png" alt="Black" class="color-selector" onclick="changeColor('Black')">
                </div>
            </div>
            <div class="mb-3">
                <strong>Size:</strong>
...
document.addEventListener('DOMContentLoaded', function () {
    const productId = 7; // Replace with your dynamic product ID
    loadProductRating(productId);
        ...
        <div class="tab-content" id="productTabContent">
            ...
            <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab" style="padding: 20px; border: 1px solid #ddd; border-radius: 5px;">
                <p>The Double-Breasted Collar Pressed-Pleated Dress is a chic, sophisticated piece that blends classic elegance with modern flair. Its tailored double-breasted design and pressed pleats offer a flattering silhouette, making it the perfect choice for both formal occasions and stylish everyday wear.</p>
            </div>
...
<ul>
    <li>Double-Breasted Collar Design</li>
    <li>Pressed Pleats for a Structured Look</li>
    <li>Tailored Fit for a Flattering Silhouette</li>
    <li>Button-Down Front for Classic Style</li>
</ul>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="reviewForm">
                    <!-- Set product_id to 7 dynamically -->
...
<script>
    ...
    const productId = document.getElementById('productId').value; // Product ID set to 7
    ...
    function changeColor(color) {
        ...
        if (color === "Red") {
            sidebarImages.innerHTML = `
                <img src="red.png" alt="Red Thumbnail 1" onclick="changeMainImage('red.png', 'Red')">
                <img src="red1.png" alt="Red Thumbnail 2" onclick="changeMainImage('red1.png', 'Red')">
            `;
            changeMainImage("red.png", "Red"); // Update to Red
            colorText.textContent = "Red"; // Update displayed color
        } else if (color === "Black") {
            sidebarImages.innerHTML = `
                <img src="blackdress.png" alt="Black Thumbnail 1" onclick="changeMainImage('blackdress.png', 'Black')">
                <img src="blackdress1.png" alt="Black Thumbnail 2" onclick="changeMainImage('blackdress1.png', 'Black')">
            `;
            changeMainImage("blackdress.png", "Black"); // Update to Black
            colorText.textContent = "Black"; // Update displayed color
        }
    }
