...
<head>
    ...
    <title>StyleGen Gentlemen's Light Brown Denim Pants</title>
...
<div class="container content-container" style="font-family: 'Poppins', sans-serif; font-weight: bold; font-size: 0.9rem; margin-bottom: 20px;">
    <div class="product-page">
        ...
        <div class="sidebar-images">
            <img src="Gentlemen/brownp1.png" alt="Thumbnail Multicolor 1" onclick="changeMainImage('Gentlemen/brownp1.png', 'Brown')">
            <img src="Gentlemen/brownp2.png" alt="Thumbnail Multicolor 2" onclick="changeMainImage('Gentlemen/brownp2.png', 'Brown')">
            <img src="Gentlemen/brownp3.png" alt="Thumbnail Multicolor 2" onclick="changeMainImage('Gentlemen/brownp3.png', 'Brown')">
            <img src="Gentlemen/brownp4.png" alt="Thumbnail Multicolor 2" onclick="changeMainImage('Gentlemen/brownp4.png', 'Brown')">

        </div>

        <!-- Main Image -->
        <div class="main-image">
        <img id="mainProductImage" src="Gentlemen/brownp1.png" alt="Main Product Image" onclick="showSelectedColor()" style="border: 2px solid #ddd; border-radius: 4px; padding: 5px; margin-bottom: 50px;">
        </div>

        <!-- Product Details -->
        <div class="product-details">
            <h1>StyleGen Gentlemen's Light Brown Denim Pants</h1>
        ...
        (<span id="reviewCount">0</span> Reviews)
                ...
                <p class="price" style="color: #B0C6B5;"><strong>₱679.00</strong> </p>
            <div class="mb-3">
            </div>
            <div class="mb-3">
                <strong>Size:</strong>
...
document.addEventListener('DOMContentLoaded', function () {
    const productId = 15; // Replace with your dynamic product ID
    loadProductRating(productId);
        ...
        <div class="tab-content" id="productTabContent">
            ...
            <p>
            The StyleGen Gentlemen's Light Brown Denim Pants are perfect for a laid-back yet stylish look. Made with premium denim, these pants offer durability, comfort, and a versatile color that pairs well with various tops. Featuring a classic straight-leg cut and a contemporary light brown shade, they can easily be dressed up or down. Whether you're going for a casual day out or a semi-formal gathering, these pants are a wardrobe essential.
        </p>
        </div>
            ...
            <p>
            - Regular fit through the hips and thighs for a comfortable, straight-leg look.<br>
            - Light brown color that’s perfect for casual or semi-formal occasions.<br>
            - Model is wearing size 32 and is 6'0" tall.<br>
            - For a more tailored fit, consider sizing down.
        </p>
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 10px;">
            ...
            <p>
            These denim pants are crafted from high-quality cotton with a slight stretch to ensure comfort throughout the day. The fabric is soft to the touch yet durable enough for everyday wear. The light brown hue adds a touch of warmth to the classic denim look, making it a versatile piece in your wardrobe.
        </p>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="reviewForm">
                    <!-- Set product_id to 15 dynamically -->
...
<script>
    ...
    const productId = document.getElementById('productId').value; // Product ID set to 15
