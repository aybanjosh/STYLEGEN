...
<body>
    ...
    <h2 class="section-title" style="text-align:center">LADIES' OUTFITS</h2><br>
        ...
        <div class="col-md-3 col-sm-6">
            <a href="product1.php" class="text-decoration-none text-dark">
                <div class="product-card">
                    <img src="blackdress.png" alt="Product 1" class="product-image">
                    <div class="product-details">
                        ...
                        <p class="product-price" style="color: #687B61;">₱766.00 <span style="color: #F8D0C8;"><del>₱831.00</del></span></p>
        ...
        <a href="product6.php" class="text-decoration-none text-dark">
            <div class="product-card">
                <img src="green.png" alt="Product 2" class="product-image">
                <div class="product-details">
                    ...
                    <p class="product-price" style="color: #687B61;">₱794.00 <span style="color: #F8D0C8;"><del>₱993.00</del></span></p>
                    <div class="product-actions">
                    <button class="cart-btn">Add to Cart</button>
        ...
        <a href="arrivals3.php" class="text-decoration-none text-dark">
            <div class="product-card">
                <img src="new3.png" alt="Product 3" class="product-image">
                <div class="product-details">
                    ...
                    <p class="product-price" style="color: #687B61;">₱2,295.00 </p>
                    <div class="product-actions">
                        <button class="cart-btn">Add to Cart</button>
        ...
        <!-- Product Card 4 -->
        <div class="col-md-3 col-sm-6">
        <a href="lady1.php" class="text-decoration-none text-dark">
            ...
            <div class="product-card">
                ...
                <div class="product-details">
                    ...
                    <p class="product-price" style="color: #687B61;">₱1,799.00 </p>
                    <div class="product-actions">
                        <button class="cart-btn">Add to Cart</button>
                        <span style="color: orange;">☆☆☆☆☆</span>
                    </div>
            ...
            <!-- Product Card 5 -->
            <div class="col-md-3 col-sm-6">
            <a href="lady2.php" class="text-decoration-none text-dark">
                ...
                <div class="product-card">
                    ...
                    <div class="product-details">
                        ...
                        <p class="product-price" style="color: #687B61;">₱1,899.00 </p>
                        <div class="product-actions">
                            <button class="cart-btn">Add to Cart</button>
                            <span style="color: orange;">☆☆☆☆☆</span>
                        </div>
            ...
            <div class="col-md-3 col-sm-6">
            <a href="lady3.php" class="text-decoration-none text-dark">
            ...
            <div class="product-card">
                ...
                <div class="product-details">
                    ...
                    <p class="product-price" style="color: #687B61;">₱575.00 </p>
                    <div class="product-actions">
                    <button class="cart-btn">Add to Cart</button>
                    <span style="color: orange;">4.7 ★★★★★</span>
                    </div>
                </div>
            </div>
</a>
        ...
        <!-- Product Card 8 -->
        <div class="col-md-3 col-sm-6">
        <a href="lady4.php" class="text-decoration-none text-dark">
            <div class="product-card">
        ...
        <!-- Product Card 9 -->
        <div class="col-md-3 col-sm-6">
        <a href="lady5.php" class="text-decoration-none text-dark">
            ...
            <div class="product-card">
                ...
                <div class="product-details">
                    ...
                    <p class="product-price" style="color: #687B61;">₱785.00 <span style="color: #F8D0C8;"><del>₱1,095.00</del></span></p>
                    <div class="product-actions">
                    <button class="cart-btn">Add to Cart</button>
        ...
        <!-- Product Card 10 -->
        <div class="col-md-3 col-sm-6">
        <a href="lady6.php" class="text-decoration-none text-dark">
            ...
            <div class="product-card">
                ...
                <div class="product-details">
                    ...
                    <p class="product-price" style="color: #687B61;">₱300.00 </p>
                    <div class="product-actions">
                    <button class="cart-btn">Add to Cart</button>
                    <span style="color: orange;">4.7 ★★★★★</span>
                    </div>
        ...
        <!-- Product Card 11 -->
        <div class="col-md-3 col-sm-6">
        <a href="lady7.php" class="text-decoration-none text-dark">
            <div class="product-card">
                ...
                <div class="product-details">
                    ...
                    <p class="product-price" style="color: #687B61;">₱599.00 </p>
                    <div class="product-actions">
                    <button class="cart-btn">Add to Cart</button>
                    <span style="color: orange;">4.9 ★★★★★</span>
                    </div>
        ...
        <a href="arrivals6.php" class="text-decoration-none text-dark">
            ...
            <div class="product-card">
                <img src="new5.png" alt="Product 12" class="product-image">
                <div class="product-details">
                    <span class="product-label" style="background-color: #F8D0C8; color: white;">NEW</span>
                    <h5 class="product-title">StyleGen Ladies Knit Midi Skirt</h5>
                    <p class="product-price" style="color: #687B61;">₱1,495.00 </p>
                    <div class="product-actions">
                    <button class="cart-btn">Add to Cart</button>
                    <span style="color: orange;">☆☆☆☆☆</span>
                    </div>
        ...
        <div class="col-md-3 col-sm-6">
        <a href="lady8.php" class="text-decoration-none text-dark">
            ...
            <ul class="navbar-nav d-flex align-items-center">
                ...
                <li class="nav-item ms-3">
                    <form class="d-flex" role="search">
                        <input class="form-control me-1" type="search" placeholder="Search Products" aria-label="Search" style="font-size: 0.8rem;">
