...
<head>
    ...
    <title>StyleGen Gentlemen Straight Leg Cargo Pants</title>
...
<div class="container content-container" style="font-family: 'Poppins', sans-serif; font-weight: bold; font-size: 0.9rem;">
    <div class="product-page">
        ...
        <img id="mainProductImage" src="new8.png" alt="Main Product Image" onclick="showSelectedColor()" style="border: 2px solid #ddd; border-radius: 4px; padding: 5px; margin-bottom: 50px;">
        </div>

        <!-- Product Details -->
        <div class="product-details">
            <h1>StyleGen Gentlemen Straight Leg Cargo Pants</h1>
        ...
        (<span id="reviewCount">0</span> Reviews)
            ...
            <p class="price" style="color: #B0C6B5;"><strong>₱1,200.00</strong> </p>
            <div class="mb-3">
...
document.addEventListener('DOMContentLoaded', function () {
    const productId = 18; // Replace with your dynamic product ID
...
<div class="tab-content" id="productTabContent">
    ...
    <p>StyleGen Gentlemen Straight Leg Cargo Pants are the perfect blend of utility and style. These pants are designed with functional pockets and a sleek straight-leg cut to give you a modern, relaxed fit. Whether you're heading to work or enjoying a weekend outing, these cargo pants provide both comfort and practicality with a stylish edge.</p>
    </div>
    ...
    <p>
            - Straight leg design with a relaxed fit.<br>
            - Functional side pockets and back pockets.<br>
            - Available in waist sizes 30 to 34 for a comfortable fit.<br>
            - Model is wearing size 32 and is 5'10" tall.<br>
            - For a looser fit, you may want to size up.
        </p>
    ...
    <p>The StyleGen Gentlemen Straight Leg Cargo Pants are made from a premium blend of 98% cotton and 2% spandex, ensuring durability and flexibility for all-day wear. The soft cotton provides comfort, while the small amount of spandex offers a slight stretch for better movement. The pants feature reinforced stitching, making them long-lasting and practical for everyday use.</p>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="reviewForm">
                    <!-- Set product_id to 18 dynamically -->
                    <input type="hidden" id="productId" value="18">
...
<script>
    ...
    const productId = document.getElementById('productId').value; // Product ID set to 18
